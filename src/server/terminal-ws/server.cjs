...
if (DOCKER_IMAGE.includes('/') || DOCKER_IMAGE.includes(':')) {
...
setInterval(() => {
    console.log(`Stats: Containers: ${activeContainers}/${MAX_CONCURRENT_CONTAINERS}, Queue: ${containerQueue.length}, Connections: ${connections.size}`);
