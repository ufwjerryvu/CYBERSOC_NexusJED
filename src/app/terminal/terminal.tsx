  ...
  useEffect(() => {
    ...
    try {
      ...
      wsRef.current.onopen = () => {
        // Use AttachAddon with bidirectional: false to prevent local echo
        const attachAddon = new AttachAddon(wsRef.current!, { bidirectional: false });
        term.loadAddon(attachAddon);
        
        // Handle input manually to avoid double sending
        term.onData((data) => {
